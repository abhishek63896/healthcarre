...
def doctor_list(request):
    ...
    return render(request, 'doctors/doctors_list.html', {'doctors': doctors, 'query': query})
...
def doctor_detail(request, pk):
    ...
    return render(request, 'doctors/doctors_detail.html', {
        'doctor': doctor,
...
def doctor_create(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('doctors_detail', pk=doctor.pk)
    else:
        form = DoctorForm()
    
    return render(request, 'doctors/doctors_form.html',  {
        'form': form,
...
def doctor_delete(request, pk):
    ...
    return render(request, 'doctors/doctors_confirm_delete.html', {'doctor': doctor})
